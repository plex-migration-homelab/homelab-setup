# Generated by Powerlevel10k configuration wizard on 2025-11-06 at 18:35 UTC.
# Based on romkatv/powerlevel10k/config/p10k-lean-8colors.zsh, checksum 31091.
# Wizard options: nerdfont-v3 + powerline, small icons, lean_8colors, ascii, 12h time,
